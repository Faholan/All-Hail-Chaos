...
class Moderation(commands.Cog):
    ...
    async def reputation(self,ctx,*,other:typing.Union[discord.Member,int]):
        ...
        response=requests.get('https://discordrep.com/api/rep/'+ID+'?authorization='+self.bot.discord_rep)
        reputation=response.json()
        response=requests.get('https://discordrep.com/api/u/'+ID+'?authorization='+self.bot.discord_rep)
        user=response.json()
        response=requests.get('https://discordrep.com/api/bans/'+ID+'?authorization='+self.bot.discord_rep)
        ban=response.json()
        response=requests.get('https://discordrep.com/api/warns/'+ID+'?authorization='+self.bot.discord_rep)
